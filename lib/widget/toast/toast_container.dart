...
class _GuiToastContainer extends StatefulWidget {
  ...
  const _GuiToastContainer({
    Key key,
    this.duration,
    this.child,
    this.movingOnWindowChange = false,
    this.position, 
    this.animationBuilder, this.animationDuration, this.animationCurve
  }) : super(key: key);

    @override
  __GuiToastContainerState createState() => __GuiToastContainerState();
}

class __GuiToastContainerState extends State<_GuiToastContainer>
